...
class MyHandler(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if count == 2:
            ...
            return
        if count < 3:
            self.wfile.write(FIRST_RESPONSE.encode())
        else:
            self.wfile.write(SECOND_RESPONSE.encode())
